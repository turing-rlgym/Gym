...
**Reference**: Refer to [Generation Backend And Openai Compatible Http Server](/latest/contribute/rl-framework-integration/generation-backend-and-openai-compatible-http-server) for implementation guidance.
...
**Reference**: Refer to [On-Policy Corrections](/latest/contribute/rl-framework-integration/openai-compatible-http-server-on-policy-correction) for technical details.
...
- [Gym Rl Framework Integration Success Criteria](/latest/contribute/rl-framework-integration/gym-rl-framework-integration-success-criteria) - Validate your integration
- [Generation Backend And Openai Compatible Http Server](/latest/contribute/rl-framework-integration/generation-backend-and-openai-compatible-http-server) - Generation backend setup

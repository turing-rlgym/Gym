...
Verify that your integration implements all required components as specified in [Gym Integration Footprint And Form Factor](/latest/contribute/rl-framework-integration/gym-integration-footprint-and-form-factor):
...
1. **Training crashes**: Check for off-policy issues. Refer to [On-Policy Corrections](/latest/contribute/rl-framework-integration/openai-compatible-http-server-on-policy-correction)
...
- [Gym Integration Footprint And Form Factor](/latest/contribute/rl-framework-integration/gym-integration-footprint-and-form-factor) - Required integration components
- [On-Policy Corrections](/latest/contribute/rl-framework-integration/openai-compatible-http-server-on-policy-correction) - On-policy training fixes

...
<NavButton href="/latest/training-tutorials/nemo-rl-grpo/setup" label="Previous: Setup" direction="prev" />
...
- ✅ Completed the [Setup](/latest/training-tutorials/nemo-rl-grpo/setup) instructions
...
<NavButton href="/latest/training-tutorials/nemo-rl-grpo/multi-node-training" label="Continue to Multi-Node Training" direction="next" />

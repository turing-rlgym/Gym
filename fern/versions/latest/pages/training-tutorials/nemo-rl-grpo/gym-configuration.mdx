...
<NavButton href="/latest/training-tutorials/nemo-rl-grpo/about-workplace-assistant" label="Previous: About Workplace Assistant" direction="prev" />

## Prerequisites

- Read [About Workplace Assistant](/latest/training-tutorials/nemo-rl-grpo/about-workplace-assistant) to understand the training environment
...
|-----------|-------------|
| `train_jsonl_fpath` | Path to training dataset (prepared in [Setup](/latest/training-tutorials/nemo-rl-grpo/setup)) |
...
<NavButton href="/latest/training-tutorials/nemo-rl-grpo/nemo-rl-configuration" label="Continue to NeMo RL Configuration" direction="next" />

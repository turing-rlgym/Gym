...
- Completed [Detailed Setup](/latest/get-started/detailed-setup)
- Collected rollouts ([Rollout Collection](/latest/get-started/rollout-collection))
...
<Card title="GRPO Training" href="/latest/training-tutorials/nemo-rl-grpo">

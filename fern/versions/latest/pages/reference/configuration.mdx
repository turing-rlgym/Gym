...
<Note>
[Configuration](/latest/about/concepts/configuration) for understanding how configs are structured and how servers connect.
...
<Note>
[Configuration](/latest/troubleshooting/configuration) for common configuration errors and solutions.

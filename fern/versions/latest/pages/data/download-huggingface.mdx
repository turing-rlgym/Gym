...
**Prerequisites**: NeMo Gym installed ([Detailed Setup](/latest/get-started/detailed-setup))
...
<Card title="Collect Rollouts" href="/latest/get-started/rollout-collection">

Generate training examples by running your agent on prepared data.
</Card>

<Card title="Train with NeMo RL" href="/latest/training-tutorials/nemo-rl-grpo">

...
- **NeMo Gym installed**: See [Detailed Setup](/latest/get-started/detailed-setup)
...
<Card title="Prepare and Validate" href="/latest/data/prepare-validate">
Full data preparation workflow.

<Badge minimal outlined>data-prep</Badge>
</Card>

<Card title="Download from Hugging Face" href="/latest/data/download-huggingface">
Fetch datasets from HuggingFace Hub.

<Badge minimal outlined>huggingface</Badge>
</Card>

<Card title="Prompt Config" href="/latest/data/prompt-config">
...
See [Cli Commands](/latest/reference/cli-commands) for details.

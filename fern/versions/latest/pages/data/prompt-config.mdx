...
**Prerequisites**:
- NeMo Gym installed ([Detailed Setup](/latest/get-started/detailed-setup))
...
See [Cli Commands](/latest/reference/cli-commands) for the full list of `ng_collect_rollouts` parameters.

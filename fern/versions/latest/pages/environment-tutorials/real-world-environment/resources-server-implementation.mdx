...
This page covers the **Resources Server** implementation for the [Workplace Assistant](/latest/environment-tutorials/real-world-environment) environment. The full workflow — task data preparation, agent/model configuration, rollout collection, and training — follows the same steps as the [single-step tutorial](/latest/environment-tutorials/single-step-environment). What changes here is the scale and complexity of the Resources Server.

<NavButton href="/latest/environment-tutorials/real-world-environment/generating-training-data" label="Generating Training Data" direction="prev" />
...
<Tip>
For a deeper dive into verification strategies, reward shaping, and common pitfalls, see [task-verification](/latest/about/concepts/task-verification).

</Tip>

---

<NavButton href="/latest/environment-tutorials/real-world-environment" label="Back to Workplace Assistant" direction="back" />

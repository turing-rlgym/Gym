...
- [core-components](/latest/about/concepts/core-components) — Model, Resources, and Agent servers
- [architecture](/latest/about/concepts/architecture) — How components interact during startup and execution
- [task-verification](/latest/about/concepts/task-verification) — Reward computation and verification patterns
- [configuration-concepts](/latest/about/concepts/configuration) — YAML configuration system
</Accordion>
...
<Card title="Single-Step Environment" href="/latest/environment-tutorials/single-step-environment">
...
<Card title="Multi-Step Environment" href="/latest/environment-tutorials/multi-step-environment">
Multiple sequential tool calls with ground-truth verification.

<Badge intent="success" minimal outlined>intermediate</Badge>
</Card>

<Card title="Stateful Environment" href="/latest/environment-tutorials/stateful-environment">
Per-episode session state with `SESSION_ID_KEY`.

<Badge intent="success" minimal outlined>intermediate</Badge>
</Card>

<Card title="Real-World Environment" href="/latest/environment-tutorials/real-world-environment">
...
<Card title="LLM-as-Judge Verification" href="/latest/environment-tutorials/llm-as-judge-verification">
...
5. **Verification method**: How the environment computes rewards from model responses. See [Task Verification](/latest/about/concepts/task-verification) for details.

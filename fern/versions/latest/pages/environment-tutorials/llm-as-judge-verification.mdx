---
title: "LLM-as-a-judge in verification"
description: ""
position: 10
---
...
For how NeMo Gym sits next to GPUs and training frameworks, see [Deployment Topology](/latest/infrastructure/deployment-topology).

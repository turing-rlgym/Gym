...
position: 2
---
This is the quickstart—get running in under 5 minutes. For a more detailed walkthrough, see the [Detailed Setup Guide](/latest/get-started/detailed-setup).
...
> **Note:** We use GPT-4.1 in this quickstart because it provides low latency (no reasoning step) and works reliably out-of-the-box. NeMo Gym is **not limited to OpenAI models**—you can use self-hosted models via vLLM or any OpenAI-compatible inference server that supports function calling. Refer to the [Detailed Setup Guide](/latest/get-started/detailed-setup) for details.
...
<Card title="Start Training" href="/latest/training-tutorials">

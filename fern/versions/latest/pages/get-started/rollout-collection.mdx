...
<NavButton href="/latest/get-started/detailed-setup" label="Previous: Detailed Setup Guide" direction="prev" />
...
- ✅ Completed [Detailed Setup Guide](/latest/get-started/detailed-setup)
...
If you still have servers running from the [Detailed Setup Guide](/latest/get-started/detailed-setup) tutorial, proceed to the next step.
